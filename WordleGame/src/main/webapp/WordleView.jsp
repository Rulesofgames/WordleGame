...
<body> 
	...
	<script>
      ...
      function generateWordleWord(){
    	  console.log("generateWordleWord()");
      ...
      userInput.forEach((array,rowIndex)=>{ 
    	  array.forEach((key,colIndex)=>{
    		  ...
    		  //set id of grid according to its row and column values
      ...
      //display keyboard
       ...
       alphabetArray.forEach(item=>{
          ...
          btn.innerText=item;
          // Add click Event listener for user input
